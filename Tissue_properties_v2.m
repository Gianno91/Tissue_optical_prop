...
% Version: 2
% Date of the current version: November, 28th, 2016
% Biomedical Optics Research Laboratory (BORL),
% Department of Medical Physics and Biomedical Engineering,
% University College London (UCL), London, UK

function [mu_s,mu_a] = Tissue_properties_v2(lambda,g,a,b,B,S,C_HGb,W,F,C_oxCCO,C_redCCO)
...
% 7) C_HGb = Total concentration of hemoglobin in the tissue [uM];
% 8) W = Water content in the tissue;
% 9) F = Fat content in the tissue;
% 10) C_oxCCO = Concentration of oxidized cytochrome c-oxidase (CCO) in the tissue [uM];
% 11) C_redCCO = Concentration of reduced cytochrome c-oxidase (CCO) in the tissue [uM];
...
mu_a_HbO2=C_HGb*abs_HbO2; % Absorption coefficients of HbO2 for the given wavelength [cm^-1];
mu_a_HHb=C_HGb*abs_HHb; % Absorption coefficients of HHb for the given wavelength [cm^-1];
